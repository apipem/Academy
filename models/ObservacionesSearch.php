...
/**
 * ObservacionesSearch represents the model behind the search form of `app\models\Observaciones`.
 */
class ObservacionesSearch extends Observaciones
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'idobservaciones' => $this->idobservaciones,
            'funcionario_idfuncionarios' => $this->funcionario_idfuncionarios,
